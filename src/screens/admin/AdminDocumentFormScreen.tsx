...
export const AdminDocumentFormScreen: React.FC<AdminDocumentFormScreenProps> = ({
  ...
  const [pages] = useState(existingItem?.pages || '');
  ...
  return (
    <PageContainer>
      <AdminPageHeader
        title={isEdit ? 'दस्तावेज संपादित करें' : 'नया दस्तावेज जोड़ें'}
        subtitle={isEdit ? 'विवरण बदलें' : 'PDF फ़ाइल अपलोड करके प्रकाशित करें'}
      ...
      <div className="bg-white dark:bg-[#1E293B] border border-[#E8E5DF] dark:border-[#334155] rounded-2xl p-5 shadow-2xs space-y-5">
        {/* 1. Title */}
        <div>
          <label htmlFor="doc-title" className="block text-[13.5px] font-bold text-[#1F2421] dark:text-gray-200 mb-1.5">
            दस्तावेज का शीर्षक <span className="text-red-500">*</span>
          </label>
          <input
            id="doc-title"
            type="text"
            ...
            placeholder="दस्तावेज का नाम लिखें…"
